export default function About() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-amber-50 via-stone-50 to-amber-50/40 py-20">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <div className="w-32 h-1.5 bg-gradient-to-r from-transparent via-amber-600 to-transparent mx-auto mb-8 rounded-full"></div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          {teamMembers.map((member) => (
            ...
            >
              {/* Image Container */}
              <div className="relative h-64 overflow-hidden bg-gradient-to-br from-amber-100 to-stone-200">
                <img
                  src={member.img}
                  alt={member.name}
        ...
        <div className="mt-20 text-center">
          <div className="inline-block bg-gradient-to-r from-amber-600 to-amber-700 rounded-2xl shadow-2xl p-8 md:p-12 max-w-3xl">
